...
namespace MakeActions
{
    public class Function
    {
        ...
        private IModelStore<MakeActionsInputs> store;

        public async Task<MakeActionsOutputs> Handler(MakeActionsInputs args, ILambdaContext context)
        {
            ...
            { 
                ...
                {
                    this.store = new S3ModelStore<MakeActionsInputs>(RegionEndpoint.GetBySystemName("us-west-1"));
                }
                else
                {
                    this.store = new UrlModelStore<MakeActionsInputs>();
                }
            }

            var l = new InvocationWrapper<MakeActionsInputs,MakeActionsOutputs> (store, MakeActions.Execute);
